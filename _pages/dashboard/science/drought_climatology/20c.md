...
![Figure 1: schematic representation of the modelling setups used to derived the two products]({{ site.science_url }}/drought_climatology/21c/). ]({{site.baseurl}}/assets/img/Benoit1.jpg)
