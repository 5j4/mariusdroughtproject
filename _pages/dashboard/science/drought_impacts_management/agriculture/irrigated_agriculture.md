...
![Estimated irrigation benefits (£) per 2km x 2km grid cell]({{ site.baseurl }}/assets/images/irrigated_agriculture_estimated_benefits.jpg){:height="50%"}
...
![Irrigation water productivity (£/m<sup>3</sup>)]({{ site.baseurl }}/assets/images/irrigated_water_productivity.jpg){:height="50%"}
