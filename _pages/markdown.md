...
(paragraph) Lorem ipsum dolor sit amet, consectetur adipisicing elit. Facere sapiente veniam delectus optio expedita vero aspernatur, quidem sed dicta quae, voluptatem cum. Asperiores aliquam necessitatibus labore nam voluptas, enim recusandae?
...
An EXTERNAL [LINK](http://www.google.com) that opens in CURRENT window/tab

``[link](http://www.google.com)``

An EXTERNAL [LINK](http://www.google.com){:target="_blank"} that opens in a NEW browser window/tab

``[link](http://www.google.com){:target="_blank"}``

An INTERNAL [LINK]({{ site.science_url }}/ "Title") "Title") + title attribute

``[LINK]({{ site.science_url }}/ "Title") "Title")``

An INTERNAL [LINK]({{ site.science_url }}/), NO title attribute.

``[LINK]({{ site.science_url }}/)``

### URL shortcut variables
...
``{% raw %}{{ site.assets_url }}{% endraw %}`` = {{ site.assets_url }}/

``{% raw %}{{ site.images_url }}{% endraw %}`` = {{ site.images_url }}

``{% raw %}{{ site.data_url }}{% endraw %}`` = {{ site.data_url }}
...
``{% raw %}{{ site.base_url }}{% endraw %}`` = {{ site.base_url }}/

``{% raw %}{{ site.science_url }}{% endraw %}`` = {{ site.science_url }}

``{% raw %}{{ site.dpe_url }}{% endraw %}`` = {{ site.dpe_url }}
